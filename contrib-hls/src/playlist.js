...
const backwardDuration = function(playlist, endSequence) {
    ...
    //if a start time is available for segment immediately following the interval, use it
 ...
 * for seeking
 */
export const seekable = function(playlist, expried) {
    let useSafeLiveEnd = true;
    let seekableStart = expired || 0;
    let seekableEnd = playlistEnd(playlist, expried, useSafeLiveEnd);
...
export const getMediaInfoForTime = function(playlist, currentTime, startIndex, startTime){
    let i;
    let segment;
