 ...
 * property depending on whether the segment is encrypted or not
 ...
 * before continuing processing via it's callback. The function gathers errors
...
const waitForCompletion = (activeXhrs, decrypter, doneFn) => {
    ...
    return (error, segment) => {
        ...
        if(count === activeXhrs.length) {
            ...
            segment.endOfAllRequest = Date.now();
